...
const JustDoIt = () => {
  return (
    <div
      className="lg:px-14 lg:py-20 xl:p-30 h-fit bg-no-repeat bg-cover bg-center"
    ...
    >
      ...
      <Image src={starsIcon} alt="stars_icon" className="relative ml-auto lg:mb-[-100px] xl:mb-[-110px] lg:mr-2 xl:mr-5 z-50"/>
      <div className="grid grid-cols-3 lg:gap-x-3.5 xl:gap-x-0.5 lg:mt-10 xl:mt-14">
        {shop.map((item) => (
          <div className=" relative" key={item.title}>
            <Image
              ...
              height={407}
            />
            <div className="flex flex-wrap justify-center gap-6 absolute lg:bottom-10 xl:bottom-15 left-1/2 transform -translate-x-1/2">
