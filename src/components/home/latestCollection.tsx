...
const LatestCollection = () => {
  return (
    <section className="py-26 lg:px-24 xl:px-40">
      <div className="flex items-start justify-center">
        <Image src={RaysIcon} alt="rays" className="relative bottom-3" />
        <h3
          className={`${TacticSansBold.className} lg:text-[32px] xl:text-[40px] font-normal text-white text-center uppercase text-stroke`}
        >
      ...
      <div className="bg-[#FF00000D] my-16 h-fit pr-20 rounded-tl-[231px] rounded-bl-[231px] rounded-tr-[98px] rounded-br-[98px] flex justify-between items-stretch">
        ...
        <div className="flex flex-col items-end text-right gap-y-5  py-12">
          <p
            className={`${TacticSansBold.className} font-normal lg:text-4xl xl:text-5xl text-black lg:leading-12 xl:leading-14`}
          >
            AIR JORDAN <br /> Retro 7
          </p>
          <div className="flex items-center gap-x-3.5">
            <span className="bg-brand-gray-250 text-brand-gray-300 px-2 lg:text-xl xl:text-[22px] font-normal">
              Men’s Shoes
            </span>
            <span className="lg:text-xl xl:text-[22px] text-black font-normal">2 Colors</span>
          </div>
          <p
            className={`${TacticSansBold.className} text-[#4B4B4B] lg:text-[34px] xl:text-[38px] font-normal`}
          >
            MRP: $229.99
          </p>
          <button
